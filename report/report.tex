...
\title{Big Data : Final Report\\

}

\author{\IEEEauthorblockN{1\textsuperscript{st} Luka Pavićević}
  \IEEEauthorblockA{\textit{Big Data 24/25} \\
    \textit{Univerza v Ljubljani, FRI}\\
...
formatting. Please note sections \ref{AA}--\ref{SCM} below for more
information on
...
other common scientific constants, is zero with subscript formatting,
